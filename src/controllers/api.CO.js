...
export const Send = async (req,res) =>{
    ...
    req.body.orderItems.forEach(async element => {
        ...
        await pool.query("INSERT INTO envio (id_carrito, direccion, ciudad, estado, pais, codigo_postal, fecha_envio)VALUES ($1,$2,$3,$4,$5,$6,$7);",[idcarr.rows[0].id_carrito,req.body.Direccion,req.body.Ciudad,Estado,req.body.Pais,req.body.CoP,fecha.toLocaleDateString('en-US')])
